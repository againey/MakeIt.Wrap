...
namespace Experilous.WrapAround
{
	...
	public class MechanicalGhostSpawner : GhostSpawner
	{
		public MechanicalElementGhost ghostPrefab;
		...
		protected new void Start()
		{
			...
			if (ghostPrefab == null)
			{
				...
				ghostPrefab = elementPrefab.gameObject.AddComponent<MechanicalElementGhost>();
