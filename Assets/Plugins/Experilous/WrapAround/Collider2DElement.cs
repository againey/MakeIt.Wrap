...
namespace Experilous.WrapAround
{
	...
	public class Collider2DElement : GhostableElement<Collider2DElement, Collider2DElementGhost>, IWorldConsumer
	{
		...
		public virtual bool IsCollidable(Collider2DElementGhost ghost)
		{
		...
		protected new void Start()
		{
			...
			this.DisableAndThrowOnUnassignedReference(bounds, "The Collider2DElement component requires a reference to an AbstractBounds component.");
		}
